-- Slightly modified https://github.com/redbug312/cactusbuddy/blob/master/lua/cactusbuddy.lua
--
-- Mostly just modified palette to be less dim.
-- So, credits to [redbug312](https://github.com/redbug312)!
--
-- Edited by therealnv6.
